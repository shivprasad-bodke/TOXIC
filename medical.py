...
print()
print ("Answer the questions in the form: 1->Yes 0-> No")
print ()
...
if (s1 == True and s2 == True and s6== True and s12 == True):
    print ("Detected: Fever \n Remedy: Paracetemol, Sleep for 10 hours")
